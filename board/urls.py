...
urlpatterns = [
    ...
    path('mypage/alarm/', views.alarm_list, name='alarm'),
    ...
    path('volunteer/<int:pk>/chat', views.chat_view, name='chat_view'),
    # 봉사자 목록 보기
    ...
    # 댓글 신고 기능
    path('warning_comment/<int:pk>/', views.warning_comment, name='warning_comment'),
    path('mypage/', views.MyProfileView.as_view(), name='mypage'),
    path('mypage/coin', views.coin_view, name='coin'),
    path('mypage/setting/', views.setting_page, name='setting_page'),
    path('mypage/setting/usecontent/', views.use_content, name='use_content'),
    path('mypage/setting/delete/', views.delete_user, name='delete_user'),
    #메시지
